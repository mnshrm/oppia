...
class PageVideoStreamWriter extends events_1.EventEmitter {
  ...
  isWritableStream(destinationSource) {
    if (destinationSource && typeof destinationSource !== 'string') {
      if (
        !(destinationSource instanceof stream_1.Writable) ||
  ...
  getOutputOption() {
    ...
    const videoOutputOptions =
      (_a = this.options.videOutputOptions) !== null && _a !== void 0 ? _a : [];
    const outputOptions = [];
    outputOptions.push(
      `-crf ${(_b = this.options.videoCrf) !== null && _b !== void 0 ? _b : 23}`,
    );
  ...
  addVideoMetadata(outputStream) {
    ...
    const metadataOptions =
      (_a = this.options.metadata) !== null && _a !== void 0 ? _a : [];
  ...
  getDestinationStream() {
    ...
    const outputStream = (0, fluent_ffmpeg_1.default)({
      ...
      .autopad(
        this.autopad.activation,
        (_a = this.autopad) === null || _a === void 0 ? void 0 : _a.color,
      )
